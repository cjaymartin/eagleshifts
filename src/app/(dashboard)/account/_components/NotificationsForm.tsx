...
import { z } from 'zod';
import { useUserNotificationSettingsQuery, useUpdateUserNotificationSettingsMutation } from '@/queries/team';
...
export default function NotificationsForm() {
  const { data: notificationSettings, isLoading } = useUserNotificationSettingsQuery();
  const updateNotificationsMutation = useUpdateUserNotificationSettingsMutation();
  ...
  React.useEffect(() => {
    if (notificationSettings) {
      reset({
        notifyMeBeforeShift: notificationSettings.notifyMeBeforeShift || false,
        notifyMeBeforeShiftDays: notificationSettings.notifyMeBeforeShiftDays || '',
